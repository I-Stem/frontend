...
const OrgDashboard: React.FC = (props: any) => {
  ...
  const handleLastPage = (val: number) => {
    getStudentsData(Number(val), "");
    setCurrentPage(val);
  };
    ...
    <Wrapper>
      ...
      >
        ...
        <>
          ...
          >
            Enter {userType === UserType.BUSINESS ? "employee" : "student"}{" "}
...
const OrganizationDashboard = connect(mapStateToProps, null)(OrgDashboard);
