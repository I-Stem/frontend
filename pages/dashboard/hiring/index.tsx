      ...
      <FormLayout form="hiring" hideFooter>
        <Row className="w-full">
          <Col>
            ...
            >
              {showFilters ? <CaretRightOutlined /> : <CaretLeftOutlined />}
            </span>
            <br />
            <Toast
              className="sr-only"
          ...
          >
            ...
            <div>
              ...
              <Form.Group className="csv-formgroup" controlId="status">
              ...
              <Form.Group className="csv-formgroup" controlId="natureOfJob">
                <Form.Label className="csv-select-label">
              ...
              <Form.Group className="csv-formgroup" controlId="industryElement">
              ...
              <Form.Group className="csv-formgroup" controlId="rolesElement">
                <Form.Label className="csv-select-label">
              ...
              <Form.Group
                className="csv-formgroup"
                controlId="highestEducationElement"
              >
                <Form.Label className="csv-select-label">
              ...
              <Form.Group className="csv-formgroup" controlId="highestDegree">
                <Form.Label className="csv-select-label">
              ...
              <Form.Group className="csv-formgroup" controlId="major">
                <Form.Label className="csv-select-label">
                  <h3 className="lip-subtext font-14">
              ...
              <Form.Group className="csv-formgroup" controlId="totalExperience">
                <Form.Label className="csv-select-label">
              ...
              <Form.Group className="csv-formgroup" controlId="canRelocate">
                <Form.Label className="csv-select-label">
                  <h3 className="lip-subtext font-14">
