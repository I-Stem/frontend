      ...
      <FormLayout form="jobPreferencesForm" hideFooter>
        <div className="lip-margin">
          <div tabIndex={-1} ref={initialFocus}>
            <h1 className="lip-title">Job preferences</h1>
          </div>
          <p className="lip-subtext">
            Complete this application to be considered for opportunities with
              ...
              <Form onSubmit={formik.handleSubmit} id="jobPreferencesForm">
                <fieldset>
                  <h3 className="lip-subtext lip-label font-semibold text-xl leading-9">
                    Are you seeking a job (internship or full-time) in 2021 in
                    the private sector? *
                  </h3>
                  <RadioCheck
                    htmlType="radio"
                    ...
                    id="yesJob"
                    value="true"
                    onChange={() => formik.setFieldValue("seekingJob", "true")}
                  />
                  <RadioCheck
                    htmlType="radio"
                    name="seekingJob"
                    ...
                    id="noJob"
                    value="false"
                    onChange={() => formik.setFieldValue("seekingJob", "false")}
                  />
                </fieldset>
                ...
                <fieldset>
                  ...
                  <RadioCheck
                    ...
                    id="both"
                    value="both"
                    onChange={() => formik.setFieldValue("natureOfJob", "both")}
                  />
                </fieldset>
                ...
                <Form.Group controlId="idealPosition">
                  <Form.Label>
                    <h3 className="lip-subtext lip-label font-semibold text-xl leading-9">
                      ...
                      tester, marketing manager, IT manager etc.)? Feel free to
                ...
                {formik.errors.idealPosition && formik.touched.idealPosition ? (
                ...
                formik.touched.highestEducation ? (
                  <div className="error">{formik.errors.highestEducation}</div>
                ) : null}
                <Form.Group controlId="idealPosition">
                  <Form.Label>
                    <h3 className="lip-subtext lip-label font-semibold text-xl leading-9">
                ...
                {formik.errors.highestDegree && formik.touched.highestDegree ? (
                ...
                <h3 className="lip-subtext lip-label font-semibold text-xl leading-9">
                  Select which of these disabilities do you closely associate
                  with? *
                </h3>
                <fieldset
                ...
                {formik.errors.currentPlace && formik.touched.currentPlace ? (
                ...
                <fieldset>
                  ...
                  <RadioCheck
                    ...
                    id="yesRelocate"
                    value="true"
                    onChange={() => formik.setFieldValue("canRelocate", "true")}
                  />
                  <RadioCheck
                    htmlType="radio"
                    name="canRelocate"
                ...
                Supported Input Formats: .pdf and .doc. Max filesize limit - 10
                mb
                ...
                <fieldset>
                  ...
                  <p className="lip-note">
                    Note that indicating "yes" does not guarantee a session with
                    a job coach which is solely contingent on their
                    availability.
                  </p>
                  <RadioCheck
                    htmlType="radio"
                ...
                formik.touched.needCareerHelp ? (
                  <div className="error">{formik.errors.needCareerHelp}</div>
                ) : null}
