        ...
        <Row className="tiles-row">
          <Col span={25}>
            <div ref={initialFocus} tabIndex={-1} >
              <Title className="mt-8 lip-title">Thoughts from the Infty project</Title>
            </div>
            <Text className="lip-subtext">
              Thanks to the founders of the Infty project in Japan, this webinar features exciting project progress and a teaser of what's next            </Text>
            <div className="lip-youtube">
              <iframe 
                  width="700" 
                  height="394" 
                  src="https://www.youtube.com/embed/mq4MxSANYII" 
                  frameBorder="0" 
                  allow="accelerometer; 
                  autoplay; 
                  clipboard-write; 
