...
import "./styles.scss"
import { FeedbackCategory, feedbackFormTitles } from "@Definitions/Constants/FeedbackFormConstants";

const Feedback: NextPage<IStemServices.InitialProps> = (
  props: any
) => {
  ...
  return (
    <Wrapper>
      ...
      <Form className="lip-margin" onFinish={formSubmit} form={form} id="feedbackform">
        <div tabIndex={-1} ref={initialFocus} >
          <h2 className="font-semibold text-3xl mb-12">
            Feedback For {feedbackFormTitles.get(router.query.for as FeedbackCategory)}
          </h2>
        </div>
        <label>
